...
import { ListSuspensionComponent } from '../suspension/list-suspension/list-suspension.component';

const routes: Routes = [
  { path: 'contracts', component: ContractListComponent, data: { title: 'Contratos' }, canActivate: [AuthGuard] },
  { path: 'suspensions', component: ListSuspensionComponent, data: { title: 'Suspensiones' }, canActivate: [AuthGuard] },
