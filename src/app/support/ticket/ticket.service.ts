...
export class TicketService {
  ...
  getTickets(): Observable<TicketResponse> {
    return this.clienteHttp.get<TicketResponse>(this.API + 'support', {
      headers: this.headers,
    });
  }

  getTicketByID(id: number): Observable<TicketSingleResponse> {
    return this.clienteHttp.get<TicketSingleResponse>(
      this.API + 'support/' + id,
      { headers: this.headers },
    );
  }
  ...
  addTicket(datos: TicketRequest): Observable<any> {
    return this.clienteHttp
      .post(this.API + 'support', datos, { headers: this.headers })
      .pipe(
        tap(() => {
          this._refresh$.next();
        }),
  ...
  updateTicket(id: number, datos: TicketRequest): Observable<any> {
    return this.clienteHttp.patch(this.API + 'support/' + id, datos, {
      headers: this.headers,
    });
    // .pipe(tap(() => {
    //   this._refresh$.next()
  ...
  assignTicket(ticketID: number, datos: TicketRequest): Observable<any> {
    return this.clienteHttp
      .patch<TicketRequest>(
        `${this.API}tickets/${ticketID}/assign-technician`,
        datos,
        { headers: this.headers },
      )
      .pipe(
  ...
  updateStatus(ticketID: number, datos: TicketRequest): Observable<any> {
    return this.clienteHttp
      .patch<TicketRequest>(
        `${this.API}tickets/${ticketID}/update-status`,
        datos,
        { headers: this.headers },
      )
      .pipe(
  ...
  addAttachment(
    ...
    return this.clienteHttp
      .post(`${this.API}tickets/${ticketId}/attachments`, formData, {
  ...
  deleteAttachment(attachmentId: number): Observable<any> {
    return this.clienteHttp
      .delete(`${this.API}ticket-attachments/${attachmentId}`, {
        headers: this.headers,
      })
      .pipe(
        tap(() => {
